...
import com.vtdglobal.liedetector.adapter.SoundsViewPagerAdapter;
...
public class SoundsActivity extends AppCompatActivity {
    ...
    private void replaceFragment(Fragment fragment) {
        ...
        transaction.add(R.id.layout_sounds_content, fragment);
        //transaction.addToBackStack(TEXT_SOUNDS);
        transaction.commit();
