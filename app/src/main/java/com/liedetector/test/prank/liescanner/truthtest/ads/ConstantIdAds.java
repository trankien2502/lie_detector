...
public class ConstantIdAds {
    ...
    public static ArrayList<String> listIDAdsInterScanner = new ArrayList<>();
    public static ArrayList<String> listIDAdsInterSound = new ArrayList<>();
    ...
    public static ApInterstitialAd mInterIntro;
    public static ApInterstitialAd mInterSplash;
    public static ApInterstitialAd mInterPermission;
    public static ApInterstitialAd mInterScanner;
    public static ApInterstitialAd mInterSound;
